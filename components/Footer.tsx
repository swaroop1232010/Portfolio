...
const Footer = () => (
  <div className="pt-[8rem] pb-[1rem] bg-[#007ab0]">
    <div className="grid pb-[6rem] grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-[80%] mx-auto gap-[3rem]">
      <div className="flex items-center space-x-6">
        ...
        <div>
          ...
          <p className="text-[17px] w-[90%] text-white opacity-60">Naperville Chicgo, Illinois</p>
        </div>
      </div>
      <div className="flex items-center space-x-6">
        <div className="md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5]">
      ...
      <div className="flex items-center space-x-6">
        ...
        <div>
          ...
          <p className="text-[17px] w-[90%] text-white opacity-60">swaroop1232@gmail.com</p>
        </div>
      </div>
    </div>
  </div>
