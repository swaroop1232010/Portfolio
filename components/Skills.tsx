    ...
    <div className="pt-[4rem] md:pt-[8rem] pb-[5rem] bg-[#09191a]">
      ...
      <div className="w-[80%] mx-auto pt-[4rem] md:pt-[8rem] grid grid-cols-1 md:grid-cols-2 gap-[2rem] items-center">
        <div>
            ...
            <Technologies skill1="html" skill2="CSS" skill3="JS" level1="w-[91%]" level2="w-[88%]" level3="w-[99%]"/>
        </div>
        <div>
            <SkillsItem title="Java Developer" year="2018 - 2023"/>
            <SkillsItem title="NextJS Developer" year="2017 - 2020"/>
            <Technologies skill1="Java" skill2="SpringBoot" skill3="Typescript" level1="w-[91%]" level2="w-[88%]" level3="w-[99%]"/>
        </div>
      </div>
    </div>
  );
