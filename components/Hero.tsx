      ...
      <div className="w-[90%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[3rem] h-[100%] items-center relative">
        <div>
          ...
          <p className="mt-[2rem] text-[20px] text-[#ffffff92]">
            I&apos;m a Full Stack web developer with extensive experience in both backend and
            frontend development. I have hands-on experience managing databases such as SQL and
            NoSQL, and I excel in building scalable, user-friendly applications.
          </p>
